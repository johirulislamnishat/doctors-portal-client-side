                    ...
                    <div className="blog-container">
                        <div className="blog-card">
                            <div className="card__header">
                                <img src="https://source.unsplash.com/600x400/?computer" alt="card__image" className="blog-img card__image" width="600" />
                            </div>
                            <div className="card__body">
                                <span className="blog-tag  tag-blue">Technology</span>
                        ...
                        <div className="blog-card">
                            <div className="card__header">
                                <img src="https://source.unsplash.com/600x400/?food" alt="card__image" className="blog-img card__image" width="600" />
                            </div>
                            <div className="card__body">
                                <span className="blog-tag tag-brown">Food</span>
                        ...
                        <div className="blog-card">
                            <div className="card__header">
                                <img src="https://source.unsplash.com/600x400/?car,automobile" alt="card__image" className="blog-img card__image" width="600" />
                            </div>
                            <div className="card__body">
                                <span className="blog-tag tag-red">Automobile</span>
